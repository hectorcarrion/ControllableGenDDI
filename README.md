...
[![Models](https://img.shields.io/badge/%F0%9F%A4%97%20Models-65%20disease%20LoRAs-yellow)](#per-disease-model-checkpoints)
[![License](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

Accurate dermatological diagnosis necessitates equitable performance across diverse populations, yet a systematic lack of expertly annotated images — especially for underrepresented skin tones and rare diseases — impedes progress toward measurably fair methods. We introduce **cgDDI** (**C**ontrollable **G**eneration of **D**iverse **D**ermatological **I**magery), a hybrid framework that (1) synthesizes realistic healthy skin samples without disturbing other input properties, (2) maps single-sample rare lesions onto novel skin tones and locations non-parametrically, and (3) allows for efficient parametric generation with as few as 10 training samples. We grow a 656-image dataset by more than **400×** and validate on the biopsy-confirmed Diverse Dermatology Images (DDI) and expert-verified Fitzpatrick17k (F17k) benchmarks. On DDI, cgDDI achieves **90.9%** malignancy classification accuracy (SOTA, +3.5%) alongside leading fairness metrics. Cross-dataset experiments show **+13.9%** accuracy on unseen F17k data despite minimal disease overlap.
